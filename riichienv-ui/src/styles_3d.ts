...
export const VIEWER_3D_CSS = `
    ...
    .replay-timeline { display: none; }
    .replay-timeline input { min-width: 24px; width: 0; flex: 1; margin: 0; accent-color: #65b6dc; cursor: pointer; height: 24px; }
    .replay-position { flex-shrink: 0; min-width: 64px; text-align: right; font-size: 11px; font-variant-numeric: tabular-nums; color: var(--panel-muted); }
    .replay-actions { display: grid; grid-template-columns: 1fr 1fr; align-items: center; gap: 4px 8px; }
    .replay-playback { grid-column: 1 / -1; }
    .replay-actions .replay-options { display: none; }
    ...
    .replay-dock .replay-round { padding: 2px 4px; white-space: nowrap; }
    ...
    .replay-dock select { height: 28px; font: inherit; color: #cceaff; background: var(--panel-inset); border: 1px solid var(--panel-border); border-radius: 4px; padding: 2px 4px; }
