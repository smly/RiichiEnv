...
def test_oyayame_tiebreak_extension():
    ...
    env.reset(oya=0, bakaze=2, scores=[35000, 35000, 15000, 15000])
    ...
    env.reset(oya=1, bakaze=2, scores=[35000, 35000, 15000, 15000])
...
def test_oyayame_tiebreak_last_round():
    ...
    env.reset(oya=3, bakaze=1, scores=[30000, 20000, 20000, 30000])
    ...
    env.reset(oya=3, bakaze=1, scores=[29000, 20000, 21000, 30000])
