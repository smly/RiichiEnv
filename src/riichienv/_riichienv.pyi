...
class WinResultContext:
    ...
    expected_yaku_values: list[tuple[int, int]]
    melds: list[Meld]
    seat: int
    tiles: list[int]
    ura_indicators: list[int]
    def calculate(self, calculator: HandEvaluator, conditions: Conditions | None = None) -> WinResult: ...
    def calculate_3p(self, calculator: HandEvaluator3P, conditions: Conditions | None = None) -> WinResult: ...
    def create_calculator(self) -> HandEvaluator: ...
    def create_calculator_3p(self) -> HandEvaluator3P: ...
...
class Observation:
    ...
    def encode_sp(self) -> bytes:
        ...
        Shape: ``(178, 34)`` / dtype: ``float32``.
        """
        ...
    def encode_drev(self) -> bytes:
        """Encode DREV features.
...
class MjSoulReplay:
    ...
    @staticmethod
    def from_json(path: str) -> MjSoulReplay: ...
    @staticmethod
    def from_dict(paifu: dict[str, Any] | list[list[dict[str, Any]]]) -> MjSoulReplay: ...
...
class MjaiReplay:
    ...
    @staticmethod
    def from_jsonl_text(jsonl: str, rule: str | None = None) -> MjaiReplay: ...
    @staticmethod
    def from_events(events: list[str], rule: str | None = None) -> MjaiReplay: ...
    def num_rounds(self) -> int: ...
    def take_kyokus(self) -> KyokuIterator: ...

class EventJournal:
    """Append-only MJAI log with cursor-based delayed spectator views."""

    def __init__(self) -> None: ...
    @staticmethod
    def from_jsonl(path: str | PathLike[str]) -> EventJournal: ...
    @staticmethod
    def from_jsonl_text(jsonl: str) -> EventJournal: ...
    @staticmethod
    def from_events(events: list[str]) -> EventJournal: ...
    @property
    def revision(self) -> int: ...
    @property
    def is_complete(self) -> bool: ...
    @property
    def has_in_progress_kyoku(self) -> bool: ...
    @property
    def current_kyoku_start(self) -> int | None: ...
    @property
    def events(self) -> list[str]: ...
    @property
    def completed_kyokus(self) -> list[tuple[int, int, str | None, int | None, int | None]]: ...
    def push_json(self, event: str) -> int: ...
    def events_since(self, cursor: int) -> list[str]: ...
    def event_batch_since(self, cursor: int) -> dict[str, Any]: ...
    def events_for_kyoku(self, index: int) -> list[str]: ...
    def prefix_through_completed_kyoku(self, index: int) -> list[str]: ...
    def spectator_end(self, delay_kyokus: int = 1) -> int: ...
    def spectator_prefix(self, delay_kyokus: int = 1) -> list[str]: ...
    def spectator_events_since(self, cursor: int, delay_kyokus: int = 1) -> list[str]: ...
    def spectator_batch_since(self, cursor: int, delay_kyokus: int = 1) -> dict[str, Any]: ...
    def spectator_delta(self, cursor: int, delay_kyokus: int = 1) -> tuple[int, list[str]]: ...
    def to_jsonl(self) -> str: ...
    def __len__(self) -> int: ...

class GameEngine:
    """Strict 4P/3P engine facade for new RL and server integrations."""
    ...
    @property
    def mjai_log(self) -> list[str]: ...
    @property
    def snapshot(self) -> dict[str, Any]: ...
    @property
    def event_journal(self) -> EventJournal: ...
    def decisions(self) -> dict[int, Observation | Observation3P]: ...
    def reset(
        self,
        oya: int = 0,
        ...
        riichi_sticks: int = 0,
        seed: int | None = None,
    ) -> dict[int, Observation | Observation3P]: ...
    def step(self, actions: ActionMap) -> dict[str, Any]: ...

class BatchGameEngine:
    """Deterministic serial batch of independent GameEngine instances."""
    ...
    def __len__(self) -> int: ...
    def decisions(self) -> list[tuple[int, int, Observation | Observation3P]]: ...
    def step(self, actions: Sequence[ActionMap]) -> dict[str, Any]: ...

def encode_base_batch(observations: Sequence[Observation]) -> bytes:
    """Encode `[batch, 74, 34]` float32 features in one GIL-releasing call."""
    ...

def encode_extended_batch(observations: Sequence[Observation]) -> bytes:
    """Encode `[batch, 215, 34]` float32 features."""
    ...

def encode_sp_batch(observations: Sequence[Observation]) -> bytes:
    """Encode `[batch, 178, 34]` float32 SP features."""
    ...

def encode_drev_batch(observations: Sequence[Observation]) -> bytes:
...
def encode_base_batch_3p(observations: Sequence[Observation3P]) -> bytes:
    """Encode `[batch, 74, 27]` float32 sanma features."""
    ...

def encode_extended_batch_3p(observations: Sequence[Observation3P]) -> bytes:
...
class RiichiEnv:
    ...
    def step(self, actions: ActionMap) -> dict[int, Observation]: ...
    def done(self) -> bool: ...
